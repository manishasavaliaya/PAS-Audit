...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
   ...
   public static ProgressDialog progressbar1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressbar1 = new ProgressDialog(CropImageActivity.this);
        progressbar1.setTitle("Loading..");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.imag_skip) {
            skipImage();
            return true;
        }
    ...
    protected  void  skipImage() {
        /*if (mOptions.noOutputImage) {
            ...
            progressbar1.show();
            setResult(mCropImageUri,error, 1);
        }*/
        ...
        if (mOptions.noOutputImage) {
            ...
            mCropImageView.resetCropRect1();
            mOptions.initialCropWindowPaddingRatio=0;
