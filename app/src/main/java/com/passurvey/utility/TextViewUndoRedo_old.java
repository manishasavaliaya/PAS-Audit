...
public class TextViewUndoRedo_old implements Serializable {
     ...
     */
    public TextViewUndoRedo_old(TextView textView) {
        mTextView = textView;
    ...
    // =================================================================== //
    public void TextViewUndoRedoSavedState(TextView textView)
    {
        mTextView = textView;
        mTextView.addTextChangedListener(mChangeListener);
    }
